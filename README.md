...
| `apache2__enable_mod_status`                            | `true`              | Enable apache2 module status. |
...
| `apache2__enable_mod_auth_openidc`                      | `false`             | Enable apache2 module auth openidc. |
...
| `apache2__vhosts_defaults_username`                     | root                | Set default owner/group for vhosts. |
| `apache2__vhosts_defaults_document_root_options`        | "-Index"            | Set vhosts default for what features are available in document root. (for Example: ExecCGI, FollowSymLinks, ...) https://httpd.apache.org/docs/2.4/en/mod/core.html#Options |
| `apache2__vhosts_defaults_document_root_allow_override` | None                | Set vhosts default for the types of directives that are allowed in .htaccess files in document root |
...
| Name                           | Default Value                                                         | Description                    |
|--------------------------------|-----------------------------------------------------------------------|--------------------------------|
| `name`                         | ''                                                                    | Set the name/identifier for the vhost. |
| `servername`                   | `{{ vhost.name }}`                                                    | Set Hostname that the server uses to identify itself. |
...
| `document_root`                | `{{ apache2__vhosts_defaults_vhost_root }}/{{ vhost.name }}/htdocs'`  | Set the directory that forms the main document tree visible from the web. |
| `document_root_options`        | `{{ apache2__vhosts_defaults_document_root_options }}`                | Set what features are available in document root. (for Example: ExecCGI, FollowSymLinks, ...) https://httpd.apache.org/docs/2.4/en/mod/core.html#Options |
| `document_root_allow_override` | `{{ apache2__vhosts_defaults_document_root_allow_override }}`         | Set the types of directives that are allowed in .htaccess files in document root |
